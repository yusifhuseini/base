...
.method private static final a(Ljava/lang/reflect/Constructor;)Lu3/l;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    new-instance v3, Lkotlinx/coroutines/internal/h$a;

    invoke-direct {v3, p0}, Lkotlinx/coroutines/internal/h$a;-><init>(Ljava/lang/reflect/Constructor;)V
    ...
    new-instance v3, Lkotlinx/coroutines/internal/h$b;

    invoke-direct {v3, p0}, Lkotlinx/coroutines/internal/h$b;-><init>(Ljava/lang/reflect/Constructor;)V
    ...
    new-instance v3, Lkotlinx/coroutines/internal/h$c;

    invoke-direct {v3, p0}, Lkotlinx/coroutines/internal/h$c;-><init>(Ljava/lang/reflect/Constructor;)V

    goto :goto_0

    :cond_3
    new-instance v3, Lkotlinx/coroutines/internal/h$d;

    invoke-direct {v3, p0}, Lkotlinx/coroutines/internal/h$d;-><init>(Ljava/lang/reflect/Constructor;)V
...
.method private static final d(Ljava/lang/Class;I)I
    ...
    invoke-static {p0}, Lt3/a;->b(Ljava/lang/Class;)Ly3/c;
    ...
    invoke-static {p0}, Lk3/m;->c(Ljava/lang/Object;)Z
...
.method public static final e(Ljava/lang/Throwable;)Ljava/lang/Throwable;
    ...
    check-cast p0, Lb4/e0;

    invoke-interface {p0}, Lb4/e0;->a()Ljava/lang/Throwable;
    ...
    :try_start_1
    sget-object v3, Lkotlinx/coroutines/internal/h;->c:Ljava/util/WeakHashMap;
    ...
    sget v2, Lkotlinx/coroutines/internal/h;->a:I
    ...
    invoke-static {v3, v4}, Lkotlinx/coroutines/internal/h;->d(Ljava/lang/Class;I)I
    ...
    sget-object v6, Lkotlinx/coroutines/internal/h$f;->e:Lkotlinx/coroutines/internal/h$f;
    ...
    invoke-static {v0, v2}, Ll3/a;->j([Ljava/lang/Object;Ljava/util/Comparator;)Ljava/util/List;
    ...
    invoke-static {v2}, Lkotlinx/coroutines/internal/h;->a(Ljava/lang/reflect/Constructor;)Lu3/l;
    ...
    sget-object v8, Lkotlinx/coroutines/internal/h$g;->e:Lkotlinx/coroutines/internal/h$g;
    ...
    :cond_d
    invoke-interface {v2, p0}, Lu3/l;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_f
    invoke-interface {v3, p0}, Lu3/l;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
