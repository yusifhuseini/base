...
.field private static final i:Lio/grpc/internal/c2$b;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/grpc/internal/c2;->h:Ljava/util/logging/Logger;

    invoke-static {}, Lio/grpc/internal/c2;->c()Lio/grpc/internal/c2$b;

    move-result-object v0

    sput-object v0, Lio/grpc/internal/c2;->i:Lio/grpc/internal/c2$b;
...
.method public constructor <init>(Ljava/util/concurrent/Executor;)V
    ...
    iput-object v0, p0, Lio/grpc/internal/c2;->f:Ljava/util/Queue;

    const/4 v0, 0x0

    iput v0, p0, Lio/grpc/internal/c2;->g:I

    const-string v0, "\'executor\' must not be null."

    invoke-static {p1, v0}, Lq0/l;->o(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    iput-object p1, p0, Lio/grpc/internal/c2;->e:Ljava/util/concurrent/Executor;
...
.method static synthetic a(Lio/grpc/internal/c2;)I
    ...
    iget p0, p0, Lio/grpc/internal/c2;->g:I
...
.method static synthetic b(Lio/grpc/internal/c2;I)I
    ...
    iput p1, p0, Lio/grpc/internal/c2;->g:I
...
.method private static c()Lio/grpc/internal/c2$b;
    ...
    sget-object v2, Lio/grpc/internal/c2;->h:Ljava/util/logging/Logger;
...
.method private d(Ljava/lang/Runnable;)V
    ...
    sget-object v0, Lio/grpc/internal/c2;->i:Lio/grpc/internal/c2$b;

    const/4 v1, 0x0

    const/4 v2, -0x1

    invoke-virtual {v0, p0, v1, v2}, Lio/grpc/internal/c2$b;->a(Lio/grpc/internal/c2;II)Z
    ...
    :try_start_0
    iget-object v0, p0, Lio/grpc/internal/c2;->e:Ljava/util/concurrent/Executor;
    ...
    iget-object v2, p0, Lio/grpc/internal/c2;->f:Ljava/util/Queue;

    invoke-interface {v2, p1}, Ljava/util/Queue;->remove(Ljava/lang/Object;)Z

    :cond_0
    sget-object p1, Lio/grpc/internal/c2;->i:Lio/grpc/internal/c2$b;

    invoke-virtual {p1, p0, v1}, Lio/grpc/internal/c2$b;->b(Lio/grpc/internal/c2;I)V
...
.method public execute(Ljava/lang/Runnable;)V
    ...
    iget-object v0, p0, Lio/grpc/internal/c2;->f:Ljava/util/Queue;
...
.method public run()V
    ...
    :try_start_0
    iget-object v1, p0, Lio/grpc/internal/c2;->e:Ljava/util/concurrent/Executor;

    :goto_0
    iget-object v2, p0, Lio/grpc/internal/c2;->e:Ljava/util/concurrent/Executor;
    ...
    :try_start_2
    sget-object v4, Lio/grpc/internal/c2;->h:Ljava/util/logging/Logger;
    ...
    :cond_0
    sget-object v1, Lio/grpc/internal/c2;->i:Lio/grpc/internal/c2$b;
    ...
    sget-object v2, Lio/grpc/internal/c2;->i:Lio/grpc/internal/c2$b;
