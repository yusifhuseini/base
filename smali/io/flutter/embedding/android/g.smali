...
.field private i:Lio/flutter/embedding/android/g$b;
...
.method constructor <init>(Landroid/content/Context;Landroid/media/ImageReader;Lio/flutter/embedding/android/g$b;)V
    ...
    iput-boolean p1, p0, Lio/flutter/embedding/android/g;->j:Z

    iput-object p2, p0, Lio/flutter/embedding/android/g;->e:Landroid/media/ImageReader;

    iput-object p3, p0, Lio/flutter/embedding/android/g;->i:Lio/flutter/embedding/android/g$b;
...
.method private e()V
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/g;->f:Landroid/media/Image;
    ...
    iput-object v0, p0, Lio/flutter/embedding/android/g;->f:Landroid/media/Image;
...
.method private static varargs i(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {p1, p0}, Le2/b;->f(Ljava/lang/String;Ljava/lang/String;)V
...
.method private k()V
    ...
    iput-object v1, p0, Lio/flutter/embedding/android/g;->g:Landroid/graphics/Bitmap;
    ...
    iget-object v2, p0, Lio/flutter/embedding/android/g;->f:Landroid/media/Image;

    invoke-virtual {v2}, Landroid/media/Image;->getHeight()I

    move-result v2

    iget-object v3, p0, Lio/flutter/embedding/android/g;->g:Landroid/graphics/Bitmap;
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/g;->g:Landroid/graphics/Bitmap;
...
.method public b(Lp2/a;)V
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/g;->i:Lio/flutter/embedding/android/g$b;
    ...
    :cond_0
    iget-object v0, p0, Lio/flutter/embedding/android/g;->e:Landroid/media/ImageReader;

    invoke-virtual {v0}, Landroid/media/ImageReader;->getSurface()Landroid/view/Surface;

    move-result-object v0

    invoke-virtual {p1, v0}, Lp2/a;->v(Landroid/view/Surface;)V
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/g;->h:Lp2/a;

    iput-boolean v1, p0, Lio/flutter/embedding/android/g;->j:Z
...
.method public c()V
    ...
    iget-boolean v0, p0, Lio/flutter/embedding/android/g;->j:Z
    ...
    iput-object v0, p0, Lio/flutter/embedding/android/g;->g:Landroid/graphics/Bitmap;
    ...
    iput-boolean v0, p0, Lio/flutter/embedding/android/g;->j:Z
...
.method public getAttachedRenderer()Lp2/a;
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/g;->h:Lp2/a;
...
.method public j(II)V
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/g;->e:Landroid/media/ImageReader;
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    :cond_0
    iget-object v0, p0, Lio/flutter/embedding/android/g;->g:Landroid/graphics/Bitmap;
...
.method protected onSizeChanged(IIII)V
    ...
    iget-object p3, p0, Lio/flutter/embedding/android/g;->e:Landroid/media/ImageReader;
    ...
    :cond_0
    iget-object p3, p0, Lio/flutter/embedding/android/g;->i:Lio/flutter/embedding/android/g$b;

    sget-object p4, Lio/flutter/embedding/android/g$b;->e:Lio/flutter/embedding/android/g$b;

    if-ne p3, p4, :cond_1

    iget-boolean p3, p0, Lio/flutter/embedding/android/g;->j:Z

    if-eqz p3, :cond_1

    invoke-virtual {p0, p1, p2}, Lio/flutter/embedding/android/g;->j(II)V

    iget-object p1, p0, Lio/flutter/embedding/android/g;->h:Lp2/a;

    iget-object p2, p0, Lio/flutter/embedding/android/g;->e:Landroid/media/ImageReader;

    invoke-virtual {p2}, Landroid/media/ImageReader;->getSurface()Landroid/view/Surface;

    move-result-object p2

    invoke-virtual {p1, p2}, Lp2/a;->v(Landroid/view/Surface;)V
