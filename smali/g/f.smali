...
# direct methods
.method constructor <init>(Lg/e$d;)V
    .locals 13
    ...
    iput-object v0, p0, Lg/f;->f:Ljava/util/List;
    ...
    iput-object p1, p0, Lg/f;->c:Lg/e$d;

    iget-object v0, p1, Lg/e$d;->a:Landroid/content/Context;

    iput-object v0, p0, Lg/f;->a:Landroid/content/Context;
    ...
    iget-object v3, p1, Lg/e$d;->a:Landroid/content/Context;

    if-lt v0, v1, :cond_0

    iget-object v4, p1, Lg/e$d;->K:Ljava/lang/String;
    ...
    :goto_0
    iput-object v2, p0, Lg/f;->b:Landroid/app/Notification$Builder;

    iget-object v2, p1, Lg/e$d;->R:Landroid/app/Notification;

    iget-object v3, p0, Lg/f;->b:Landroid/app/Notification$Builder;
    ...
    iget-object v5, p1, Lg/e$d;->i:Landroid/widget/RemoteViews;
    ...
    iget-object v4, p1, Lg/e$d;->e:Ljava/lang/CharSequence;

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setContentTitle(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v4, p1, Lg/e$d;->f:Ljava/lang/CharSequence;

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setContentText(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v4, p1, Lg/e$d;->k:Ljava/lang/CharSequence;

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setContentInfo(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v4, p1, Lg/e$d;->g:Landroid/app/PendingIntent;
    ...
    iget-object v4, p1, Lg/e$d;->h:Landroid/app/PendingIntent;
    ...
    iget-object v4, p1, Lg/e$d;->j:Landroid/graphics/Bitmap;
    ...
    iget v4, p1, Lg/e$d;->l:I

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setNumber(I)Landroid/app/Notification$Builder;

    move-result-object v3

    iget v4, p1, Lg/e$d;->t:I

    iget v9, p1, Lg/e$d;->u:I

    iget-boolean v10, p1, Lg/e$d;->v:Z
    ...
    iget-object v4, p0, Lg/f;->b:Landroid/app/Notification$Builder;
    ...
    iget-object v0, p0, Lg/f;->b:Landroid/app/Notification$Builder;

    iget-object v8, p1, Lg/e$d;->q:Ljava/lang/CharSequence;
    ...
    check-cast v8, Lg/e$a;

    invoke-direct {p0, v8}, Lg/f;->b(Lg/e$a;)V

    goto :goto_5

    :cond_6
    iget-object v0, p1, Lg/e$d;->D:Landroid/os/Bundle;

    if-eqz v0, :cond_7

    iget-object v8, p0, Lg/f;->g:Landroid/os/Bundle;
    ...
    :cond_8
    iget-object v0, p1, Lg/e$d;->w:Ljava/lang/String;
    ...
    :cond_a
    iget-object v0, p1, Lg/e$d;->y:Ljava/lang/String;
    ...
    :cond_b
    iget-object v0, p1, Lg/e$d;->H:Landroid/widget/RemoteViews;

    iput-object v0, p0, Lg/f;->d:Landroid/widget/RemoteViews;

    iget-object v0, p1, Lg/e$d;->I:Landroid/widget/RemoteViews;

    iput-object v0, p0, Lg/f;->e:Landroid/widget/RemoteViews;
    ...
    iget-object v8, p0, Lg/f;->b:Landroid/app/Notification$Builder;

    iget-boolean v9, p1, Lg/e$d;->n:Z
    ...
    iget-object v8, p1, Lg/e$d;->c:Ljava/util/ArrayList;

    invoke-static {v8}, Lg/f;->f(Ljava/util/List;)Ljava/util/List;

    move-result-object v8

    iget-object v9, p1, Lg/e$d;->U:Ljava/util/ArrayList;

    invoke-static {v8, v9}, Lg/f;->e(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    iget-object v9, p0, Lg/f;->g:Landroid/os/Bundle;
    ...
    iget-object v0, p1, Lg/e$d;->c:Ljava/util/ArrayList;

    invoke-static {v0}, Lg/f;->f(Ljava/util/List;)Ljava/util/List;

    move-result-object v0

    iget-object v3, p1, Lg/e$d;->U:Ljava/util/ArrayList;

    invoke-static {v0, v3}, Lg/f;->e(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    :cond_10
    iget-object v0, p1, Lg/e$d;->U:Ljava/util/ArrayList;
    ...
    :cond_11
    iget-object v0, p1, Lg/e$d;->J:Landroid/widget/RemoteViews;

    iput-object v0, p0, Lg/f;->i:Landroid/widget/RemoteViews;

    iget-object v0, p1, Lg/e$d;->d:Ljava/util/ArrayList;
    ...
    invoke-virtual {p1}, Lg/e$d;->c()Landroid/os/Bundle;
    ...
    :goto_9
    iget-object v11, p1, Lg/e$d;->d:Ljava/util/ArrayList;
    ...
    iget-object v12, p1, Lg/e$d;->d:Ljava/util/ArrayList;

    invoke-virtual {v12, v10}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;

    move-result-object v12

    check-cast v12, Lg/e$a;

    invoke-static {v12}, Lg/g;->b(Lg/e$a;)Landroid/os/Bundle;
    ...
    iget-object v3, p1, Lg/e$d;->T:Landroid/graphics/drawable/Icon;
    ...
    iget-object v3, p1, Lg/e$d;->H:Landroid/widget/RemoteViews;
    ...
    :cond_16
    iget-object v3, p1, Lg/e$d;->I:Landroid/widget/RemoteViews;
    ...
    :cond_17
    iget-object v3, p1, Lg/e$d;->J:Landroid/widget/RemoteViews;
    ...
    iget-object v7, p0, Lg/f;->b:Landroid/app/Notification$Builder;

    invoke-virtual {v4}, Lg/h;->h()Landroid/app/Person;
    ...
    iget-object v7, p1, Lg/e$d;->Q:Lg/e$c;

    invoke-static {v7}, Lg/e$c;->a(Lg/e$c;)Landroid/app/Notification$BubbleMetadata;
    ...
    :cond_1c
    iget-boolean p1, p1, Lg/e$d;->S:Z

    if-eqz p1, :cond_1f

    iget-object p1, p0, Lg/f;->c:Lg/e$d;

    iget-boolean p1, p1, Lg/e$d;->x:Z
    ...
    :goto_b
    iget-object p1, p0, Lg/f;->b:Landroid/app/Notification$Builder;
    ...
    iget-object v2, p0, Lg/f;->b:Landroid/app/Notification$Builder;
    ...
    iget-object p1, p1, Lg/e$d;->w:Ljava/lang/String;
...
.method private b(Lg/e$a;)V
    ...
    invoke-virtual {p1}, Lg/e$a;->e()Landroidx/core/graphics/drawable/IconCompat;
    ...
    :goto_0
    invoke-virtual {p1}, Lg/e$a;->i()Ljava/lang/CharSequence;

    move-result-object v2

    invoke-virtual {p1}, Lg/e$a;->a()Landroid/app/PendingIntent;
    ...
    :goto_2
    invoke-virtual {p1}, Lg/e$a;->f()[Lg/i;
    ...
    invoke-static {v1}, Lg/i;->b([Lg/i;)[Landroid/app/RemoteInput;
    ...
    :cond_3
    invoke-virtual {p1}, Lg/e$a;->d()Landroid/os/Bundle;
    ...
    iget-object v0, p0, Lg/f;->f:Ljava/util/List;

    iget-object v1, p0, Lg/f;->b:Landroid/app/Notification$Builder;

    invoke-static {v1, p1}, Lg/g;->f(Landroid/app/Notification$Builder;Lg/e$a;)Landroid/os/Bundle;
...
.method private static e(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {v0, p0}, Le/b;->addAll(Ljava/util/Collection;)Z
...
.method private static f(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {v1}, Lg/h;->g()Ljava/lang/String;
...
.method public c()Landroid/app/Notification;
    ...
    iget-object v0, p0, Lg/f;->c:Lg/e$d;

    iget-object v0, v0, Lg/e$d;->p:Lg/e$e;

    if-eqz v0, :cond_0

    invoke-virtual {v0, p0}, Lg/e$e;->b(Lg/d;)V

    :cond_0
    if-eqz v0, :cond_1

    invoke-virtual {v0, p0}, Lg/e$e;->e(Lg/d;)Landroid/widget/RemoteViews;
    ...
    :goto_0
    invoke-virtual {p0}, Lg/f;->d()Landroid/app/Notification;
    ...
    :cond_2
    iget-object v1, p0, Lg/f;->c:Lg/e$d;

    iget-object v1, v1, Lg/e$d;->H:Landroid/widget/RemoteViews;
    ...
    invoke-virtual {v0, p0}, Lg/e$e;->d(Lg/d;)Landroid/widget/RemoteViews;
    ...
    iget-object v4, p0, Lg/f;->c:Lg/e$d;

    iget-object v4, v4, Lg/e$d;->p:Lg/e$e;

    invoke-virtual {v4, p0}, Lg/e$e;->f(Lg/d;)Landroid/widget/RemoteViews;
    ...
    invoke-static {v2}, Lg/e;->a(Landroid/app/Notification;)Landroid/os/Bundle;

    move-result-object v1

    if-eqz v1, :cond_6

    invoke-virtual {v0, v1}, Lg/e$e;->a(Landroid/os/Bundle;)V
...
.method protected d()Landroid/app/Notification;
    ...
    invoke-direct {p0, v0}, Lg/f;->g(Landroid/app/Notification;)V
    ...
    iget-object v1, p0, Lg/f;->d:Landroid/widget/RemoteViews;
    ...
    :cond_4
    iget-object v1, p0, Lg/f;->e:Landroid/widget/RemoteViews;
    ...
    :cond_5
    iget-object v1, p0, Lg/f;->i:Landroid/widget/RemoteViews;
    ...
    invoke-static {v0}, Lg/g;->a(Ljava/util/List;)Landroid/util/SparseArray;
    ...
    invoke-static {v0}, Lg/e;->a(Landroid/app/Notification;)Landroid/os/Bundle;

    move-result-object v1

    new-instance v3, Landroid/os/Bundle;

    iget-object v4, p0, Lg/f;->g:Landroid/os/Bundle;
    ...
    iget-object v1, p0, Lg/f;->f:Ljava/util/List;

    invoke-static {v1}, Lg/g;->a(Ljava/util/List;)Landroid/util/SparseArray;
